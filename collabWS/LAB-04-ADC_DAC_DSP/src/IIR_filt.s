...
iir_asm_filt:
	// ADC SFR base address passe din r0, DAC SFR base address in r1
...
*/
	...
	beq wait_for_conv // beq looks for zero flag set
	...
	mul r3, r3, r6 // r3 *= 247
	smlabt r3, r4, r11, r3 // r3 += r4*260
	smlad r3, r5, r11, r3 // r3 += r5t*260 + r5b*200
	udiv r3, r3, r10 // r3 /= 832
